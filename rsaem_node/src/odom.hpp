...
#ifndef RSAEM_NODE__ODOMETRY_HPP_
#define RSAEM_NODE__ODOMETRY_HPP_
...
private:
  ...
  void update_joint_state(int32_t LeftEncoder, int32_t RightEncoder);
 ...
 // namespace jetsonai
#endif  // RSAEM_NODE__ODOMETRY_HPP_
