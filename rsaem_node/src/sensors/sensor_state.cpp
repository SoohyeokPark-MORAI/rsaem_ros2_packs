...
using jetsonai::rsaem::sensors::SensorState;
...
: Sensors(nh),
  ...
  sonar_(sonar)
{
  pub_ = nh->create_publisher<rsaem_msgs::msg::SensorState>(topic_name, this->qos_);
...
{
  auto msg = std::make_unique<rsaem_msgs::msg::SensorState>();
